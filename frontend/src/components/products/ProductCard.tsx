...
export function ProductCard({
  ...
  const handleDelete = async (e: React.MouseEvent) => {
    ...
    setIsDeleting(true);
    // Call parent — parent handles optimistic removal from list
    onDelete?.(product.id);
    // No need to reset isDeleting — component will unmount after deletion
  };
        ...
        <div className="px-4 pb-4 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              disabled={isDeleting}
              className="h-7 w-7 p-0 hover:text-red-500 hover:bg-red-50 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
              aria-label="Delete product"
            >
